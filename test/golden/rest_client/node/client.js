...
```json
{
  ...
  "id" : 192327,
  "score" : 6,
  "text" : "Justin.tv is the biggest live video site online. We serve hundreds of thousands of video streams a day, and have supported up to 50k live concurrent viewers. Our site is growing every week, and we just added a 10 gbps line to our colo. Our unique visitors are up 900% since January.<p>There are a lot of pieces that fit together to make Justin.tv work: our video cluster, IRC server, our web app, and our monitoring and search services, to name a few. A lot of our website is dependent on Flash, and we're looking for talented Flash Engineers who know AS2 and AS3 very well who want to be leaders in the development of our Flash.<p>Responsibilities<p><pre><code>    * Contribute to product design and implementation discussionsundefinedn    * Implement projects from the idea phase to productionundefinedn    * Test and iterate code before and after production release undefinedn</code></pre>undefinednQualifications<p><pre><code>    * You should know AS2, AS3, and maybe a little be of Flex.undefinedn    * Experience building web applications.undefinedn    * A strong desire to work on website with passionate users and ideas for how to improve it.undefinedn    * Experience hacking video streams, python, Twisted or rails all a plus.undefinedn</code></pre>undefinednWhile we're growing rapidly, Justin.tv is still a small, technology focused company, built by hackers for hackers. Seven of our ten person team are engineers or designers. We believe in rapid development, and push out new code releases every week. We're based in a beautiful office in the SOMA district of SF, one block from the caltrain station. If you want a fun job hacking on code that will touch a lot of people, JTV is for you.<p>Note: You must be physically present in SF to work for JTV. Completing the technical problem at <a href=undefined"http://www.justin.tv/problems/bmlundefined" rel=undefined"nofollowundefined">http://www.justin.tv/problems/bml</a> will go a long way with us. Cheers!",
  "time" : 1210981217,
...
var LucyBot = (function() {
    ...
    function LucyBot(options) {
        ...
        this.domain = domain ? domain : 'https://hacker-news.firebaseio.com/v0';
     ...
     * 
     * @method
     * @name LucyBot#getItem
     * @param {integer} itemID - The ID of the item to retrieve
     * 
     */
    LucyBot.prototype.getItem = function(parameters) {
     ...
     * 
     * @method
     * @name LucyBot#getUser
     * @param {string} username - The unique username for this user
     * 
     */
    LucyBot.prototype.getUser = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
     ...
     * 
     * @method
     * @name LucyBot#getStories
     * @param {string} storyType - The type of stories to retrieve

     * 
     */
    LucyBot.prototype.getStories = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
        ...
        var domain = this.domain;
        var path = '/{storyType}stories.json';
        ...
        path = path.replace('{storyType}', parameters['storyType']);
